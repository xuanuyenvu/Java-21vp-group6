...
INSERT INTO Book ( id, title, authorid, publisherid, pageCount, dimension, translatorName, overview, quantity, salePrice, publishdate, isHidden, hiddenParentCount ) VALUES (1, 'Marple: Twelve New Stories (2022)', 1, 5, 338, '22.88x16.55x1.55 cm', NULL, 'A brand new collection of short stories featuring the Queen of Crime’s legendary detective Jane Marple, penned by twelve remarkable bestselling and acclaimed authors.', 0, null, '2022-09-15', 'false
', 0);
